...
int verificacaoParaVencer(int contas_IA[][3], int contas_J2[][3]) {
    int i, contaIA, contaJ2, livres, alvo;
...
int regra1IA(int matrizPosicoes[][3]) {
    ...
    int verificacao = verificacaoParaVencer(contas_IA, contas_J2);
    if (verificacao != 0) {
        return verificacao;
    }
    for(c = 0; c < 3; c++){
    ...
    verificacao = verificacaoParaVencer(contas_IA, contas_J2);
    if (verificacao != 0) {
        return verificacao;
    }
...
int regra3IA(int matrizPosicoes[][3]) {
...
int regra4IA(int matrizPosicoes[][3]) {
    if (matrizPosicoes[0][0] == 400){
        if(casaLivre(matrizPosicoes, 9)){
            return 9;
        }
    }
    if (matrizPosicoes[0][2] == 400){
        if(casaLivre(matrizPosicoes, 7)){
            return 7;
        }
    }
    if (matrizPosicoes[2][0] == 400){
        if(casaLivre(matrizPosicoes, 3)){
            return 3;
        }
    }
    if (matrizPosicoes[2][2] == 400){
...
int regra5IA(int matrizPosicoes[][3]) {
    if(casaLivre(matrizPosicoes, 1)){
        return 1;
    }
    if(casaLivre(matrizPosicoes, 3)){
...
int regra6IA(int matrizPosicoes[][3]) {
