/*
	...
	* Descrição: Projeto de Programação Estruturada. Desenvolvimento de um Jogo da Velha em linguagem C. Versão socket cliente
 */
...
int main() {
	...
	inicia(&turno, nomeJogador1, nomeJogador2, simboloJ1, simboloJ2, simboloIA, MODO_CLIENTE);
