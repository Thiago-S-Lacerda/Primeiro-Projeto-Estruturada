...
int main() {
	...
	configuraJogadores(nomeJogador1, nomeJogador2, &simboloJ1, &simboloJ2, &simboloIA, &turno, MODO_PVP);
	inicia(&turno, nomeJogador1, nomeJogador2, simboloJ1, simboloJ2, simboloIA, MODO_PVP);
